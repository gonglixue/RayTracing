...
Box::Box(const glm::vec3 p0, const glm::vec3 p1)
...
Box::get_normal(const int face_hit) const {
	switch (face_hit) {
	case 0:	return (glm::vec3(-1, 0, 0));	// -x face
	case 1:	return (glm::vec3(0, -1, 0));	// -y face
	case 2:	return (glm::vec3(0, 0, -1));	// -z face
	case 3:	return (glm::vec3(1, 0, 0));	// +x face
	case 4:	return (glm::vec3(0, 1, 0));	// +y face
	case 5:	return (glm::vec3(0, 0, 1));	// +z face
	}
}